...
import { Mail, Lock, Bot, ArrowRight, Code2 } from 'lucide-react';
...
const LoginPage = () => {
  ...
  return (
    <AuthLayout>
      ...
      <div className="mb-10">
        <h2 className="text-4xl font-black tracking-tight text-text-primary mb-3">Sign In</h2>
        <p className="text-text-secondary text-sm">Enter your credentials to manage your chatbots.</p>
      </div>
      ...
      <div className="relative mb-8">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="px-4 bg-surface text-text-muted font-bold uppercase tracking-widest">or email</span>
        </div>
      </div>
      ...
      <p className="text-xs font-bold text-center mt-10 text-text-secondary">
        New here? <Link to="/signup" className="text-brand hover:text-brand-hover transition-colors ml-1">Create an account</Link>
      </p>
    </AuthLayout>
  );
};
